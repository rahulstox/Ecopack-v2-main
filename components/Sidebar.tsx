...
export function Sidebar({ totalCo2eSaved = 0 }: SidebarProps) {
    ...
    return (
        <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-green-600 to-emerald-700 text-white hidden lg:block z-40">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-white/20 bg-gradient-to-b from-green-600 to-emerald-700 z-50">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                    <div className="flex items-center gap-2 mb-2">
                        <svg className="w-5 h-5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                        </svg>
                        <p className="text-sm font-semibold text-white">Total CO₂e Saved</p>
                    </div>
                    <p className="text-3xl font-bold text-white mb-1">{Number(totalCo2eSaved || 0).toFixed(2)} kg</p>
